...
const initialPrompt = `This GPT serves as a career advisor for 16-18 year olds in Scotland seeking their first 'proper job' on a career path. It helps users understand their skills and interests and how these relate to various entry-level positions in companies across different industries. The GPT will initially only refer to jobs from the provided list:
...
const completion = await openai.chat.completions.create({
	...
	messages: [
		{
			role: 'system',
			content: 'You are a 16-18 year old in Scotland seeking your first job.',
		},
		{ role: 'user', content: initialPrompt },
		{ role: 'assistant', content: 'What are your interests?' },
	],
});
